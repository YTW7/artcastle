  ...
  const createProduct = async () => {
    try {
      ...
      if (response.status === 200) {
        alert("Art added! Refresh to Update Page");
      }
      else{
        alert("Unable to add post: ", data.error);
      }
      ...
      <div className={styles.create_product_container}>
        <div className={styles.create_product_form}>
          <header className={styles.header}>
            <h1 class="text-3xl font-black">Create Your Art Post</h1>
          </header>
          ...
          <div className={styles.form_container}>
            ...
            <div className={styles.flex_row}>
              <input
                className={styles.input}
                type="url"
                placeholder="Add No. of $SOL tokens you want as tip:"
                onChange={(e) => {
                  setNewProduct({ ...newProduct, price: e.target.value });
                }}
              />
            ...
            <div className={styles.flex_row}>
              <input
                className={styles.input}
                type="url"
                placeholder="Enter Your Art's Image URL"
                onChange={(e) => {
            ...
            <div className={styles.flex_row}>
              <input
                className={styles.input}
                type="url"
                placeholder="Your Wallet's Public Address to Recieve $SOL"
                onChange={(e) => {
